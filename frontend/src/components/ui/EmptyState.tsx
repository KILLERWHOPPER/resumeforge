  ...
  return (
    <div
      className={cn(
        ...
        'rounded-xl border-2 border-dashed border-border-light dark:border-border-dark',
    ...
    >
      {icon ||
        (defaultIcon && (
          <div className="empty-state-icon mb-4 text-text-tertiary dark:text-text-tertiary">
            {icon || defaultIcon}
          </div>
        ))}
      <h3 className="empty-state-title mb-2 text-lg font-semibold text-text-primary dark:text-text-inverse">
        {title}
      </h3>
      {description && (
        <p className="empty-state-description mb-6 max-w-sm text-sm text-text-secondary dark:text-text-secondary">
          {description}
        </p>
      )}
      {(action || secondaryAction) && (
        <div className="flex w-full max-w-xs flex-col items-center justify-center gap-3 sm:flex-row">
          {action && (
            <Button
